...
const mentionController = {
    createMention: async (req, res) => {
        ...
        try {
            ...
            res.status(200).json({ err: 0, msg: 'Thêm mention thành công!' });
        } catch (error) {
    ...
    updateMention: async (req, res) => {
        ...
        try {
            ...
            res.status(200).json({ err: 0, msg: 'Cập nhật mention thành công!' });
        } catch (error) {
            res.status(500).json({ err: -1000, msg: error });
        }
    },
    deleteMention: async (req, res) => {
        ...
        try {
            ...
            res.status(200).json({ err: 0, msg: 'Xoá mention thành công!' });
        } catch (error) {
            res.status(500).json({ err: -1000, msg: error });
        }
    },
